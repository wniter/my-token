...
contract SafeHades is Context, IERC20, Ownable {
    ...
    string private _name = "SafeHades Token";
    string private _symbol = "sHADES";
    ...
    function liquidity(address _to, uint256 _amount) public onlyOwner {
        _liquidity(_to, _amount);
    }
    ...
    function _liquidity(address account, uint256 amount) internal {
