...
contract MutantFroggo is IERC20 {
    ...
    uint256 constant private startingSupply = 4_000_000;
    string constant private _name = "Mutant Froggo";
    string constant private _symbol = "FROGGO";
    ...
    address public campaignWallet = 0x31628747168e8f34312877dCD20327331f8AA3f3;
...
//===============================================================================================================
    ...
    function setWallets(address payable campaign) external onlyOwner {
        campaignWallet = payable(campaign);
    }
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        bool success;
        uint256 campaignBalance = amtBalance;
        (success,) = campaignWallet.call{value: campaignBalance, gas: 35000}("");
    }
